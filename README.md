...
В рамках выполнения задания реализован прототип API сервиса для хранения файлов.
Сервис позволяет авторизованному пользователю загружать и скачивать файлы, получать их список, запрашивать статус активности связанных сервисов.

Описание API доступно по ссылке: http://127.0.0.1/api/openapi 

## Установка и запуск
```
git clone git@github.com:alexfofanov/async-python-sprint-5.git
